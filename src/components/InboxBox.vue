    ...
    <div class="container" ref="bgContainer">
        <v-app-bar :elevation="2" density="compact">
            <div class="top-bar">
                ...
                <div style="display: flex; justify-content: space-between;align-items: center;width: 8rem;">
        ...
        <div v-if="user" class="message-container" @scroll="handleScroll()" ref="messageContainer">
            <div
                ...
                <Transition name="slide-fade-bottom">
                    <v-btn v-show="showLoadMore" @click="loadMoreMessages()" prepend-icon="fa-solid fa-angles-up"> Load
                        More
                        Message
                    </v-btn>
                </Transition>
        ...
        <Transition name="slide-fade-bottom">
            ...
            ">
                    ...
                    <v-btn :loading='imgUploading' style="background-color: green;" @click="sendImg()"><v-icon
                            icon="fa-solid fa-cloud-arrow-up"></v-icon>
                    </v-btn>
                </div>
        ...
        <v-navigation-drawer location="right" v-if="showSetting">
            ...
            <v-list density="compact" nav>
                ...
                <UserProfile v-if="toggleMember" v-for="member in memberArray" :id="member.id"
                    :name="member.displayName" :avatar="member.avatar"></UserProfile>
            </v-list>
        </v-navigation-drawer>
